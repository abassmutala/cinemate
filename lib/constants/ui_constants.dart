...
class Insets {
  ...
  static EdgeInsets get horizontalPadding4 => EdgeInsets.symmetric(
        horizontal: Doubles.tiny,
      );
  ...
  static EdgeInsets get horizontalPadding24 => EdgeInsets.symmetric(
        horizontal: Doubles.base,
      );
  static EdgeInsets get horizontalPadding48 => EdgeInsets.symmetric(
        horizontal: Doubles.xl,
      );
